...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    ira_contributions_reported, ira_contributions_reported_sources = aggregate_numeric_fields(
        documents,
        {"5498"},
        ["deductible_ira_contributions", "traditional_ira_contributions", "traditional_ira_contribution"],
    )
    ...
    if ira_contributions_reported > 0.0 and "ira_contribution_deduction" not in answers:
        missing_items.append(
            "Review the Form 5498 IRA contribution amount and confirm the deductible traditional IRA amount before applying any IRA deduction."
        )
