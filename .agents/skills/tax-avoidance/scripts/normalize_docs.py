...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    itemized_deduction_sources = mortgage_interest_sources + charitable_sources
    ...
    if deduction_amount == 0.0 and "deduction_amount" not in answers:
        ...
        if itemized_deduction_candidates > 0.0:
            missing_items.append(
                "Itemized-deduction source documents were found. Review mortgage-interest and donation totals before choosing between standard and itemized deductions."
            )
