...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    ira_contributions_observed, ira_contributions_observed_sources = aggregate_numeric(
        documents,
        {"5498"},
        "ira_contributions",
    )
    ...
    if ira_contributions_observed > 0.0 and "ira_contribution_deduction" not in answers:
    ...
    facts = {
        ...
        "ira_contributions_observed": build_fact(
            ...
            ira_contributions_observed,
            ira_contributions_observed_sources,
        ),
