...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    taxable_social_security, taxable_social_security_document_sources = aggregate_numeric(
        documents,
        {"SSA-1099"},
        "taxable_benefits",
    )
    ...
    taxable_social_security_sources = taxable_social_security_document_sources
    if "taxable_social_security_benefits" in answers:
        taxable_social_security = safe_float(answers.get("taxable_social_security_benefits"))
        taxable_social_security_sources = [
            {
                "source_type": "user_answer",
                "source_ref": "answer:taxable_social_security_benefits",
                "field": "taxable_social_security_benefits",
    ...
    if social_security > 0.0 and not taxable_social_security_sources:
        missing_items.append(
            "Review the taxable portion of Social Security benefits before treating any SSA-1099 amount as taxable income."
        )
