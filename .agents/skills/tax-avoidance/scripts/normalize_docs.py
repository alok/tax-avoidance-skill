...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    observed_itemized_support = mortgage_interest + charitable_cash
    ...
    if deduction_amount == 0.0 and "deduction_amount" not in answers:
        if observed_itemized_support > 0.0:
            missing_items.append(
                "Choose the deduction path and provide the deduction amount to use in the draft package. "
                f"Observed itemized-deduction support currently totals ${observed_itemized_support:,.2f} "
                "from mortgage-interest and charitable-receipt documents."
            )
        else:
    ...
    normalized: dict[str, Any] = {
        ...
        "deduction_summary": {
            ...
            "observed_itemized_support": observed_itemized_support,
        },
