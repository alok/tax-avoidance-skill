...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if (traditional_ira_contributions > 0.0 or roth_ira_contributions > 0.0) and "ira_contribution_deduction" not in answers:
        missing_items.append(
            "Review the Form 5498 IRA contributions and confirm the deductible traditional IRA amount before applying any IRA deduction."
        )
    for document in documents:
