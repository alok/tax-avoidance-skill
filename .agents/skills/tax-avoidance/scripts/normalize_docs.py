...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if social_security > 0.0 and "taxable_social_security_benefits" not in answers:
        missing_items.append(
            "Review the SSA-1099 benefits and provide the taxable Social Security benefits amount for Form 1040 line 6b instead of assuming the full benefit is taxable."
        )
