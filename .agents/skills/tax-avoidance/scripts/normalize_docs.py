...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if social_security > 0.0 and "taxable_social_security_benefits" not in answers:
        missing_items.append(
            "Provide the taxable Social Security amount for Form 1040 line 6b, or leave it for professional review. Gross SSA-1099 benefits are preserved but not treated as fully taxable by default."
        )
