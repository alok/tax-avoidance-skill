...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if ira_contribution_evidence > 0.0 and "ira_contribution_deduction" not in answers:
        missing_items.append(
            f"Form 5498 shows IRA contributions totaling ${ira_contribution_evidence:,.2f}. Confirm the deductible traditional IRA amount before applying any Schedule 1 deduction."
        )
