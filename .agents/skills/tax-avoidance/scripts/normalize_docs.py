...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if traditional_ira_contributions > 0.0 and "ira_contribution_deduction" not in answers:
        missing_items.append(
            "Review the Form 5498 traditional IRA contributions totaling "
            f"${traditional_ira_contributions:,.2f} and confirm how much, if any, should be claimed as an IRA deduction."
        )
