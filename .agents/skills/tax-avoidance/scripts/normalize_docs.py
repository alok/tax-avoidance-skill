    ...
    if deduction_amount == 0.0 and "deduction_amount" not in answers:
        if mortgage_interest > 0.0 or charitable_cash > 0.0:
            missing_items.append(
                "Choose whether to take the standard deduction or itemize. Mortgage interest and/or charitable-giving documents were found, so confirm the deduction path and amount to use in the draft package."
            )
        else:
