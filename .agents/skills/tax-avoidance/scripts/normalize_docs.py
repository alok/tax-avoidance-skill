...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if social_security > 0.0 and "taxable_social_security_benefits" not in answers:
        missing_items.append(
            "Provide the taxable Social Security amount for Form 1040 line 6b, or explicitly confirm that taxable Social Security benefits should be treated as zero."
        )
