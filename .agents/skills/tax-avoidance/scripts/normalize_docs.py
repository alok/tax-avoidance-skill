...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if ira_contributions_reported > 0.0 and "ira_contribution_deduction" not in answers:
        missing_items.append(
            f"A Form 5498 reports ${ira_contributions_reported:,.2f} of IRA contributions. Confirm how much is deductible after employer-plan coverage and income-limit review."
        )
