...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    ira_contributions_documented, ira_contributions_documented_sources = aggregate_numeric(
        documents,
        {"5498"},
        "ira_contributions",
    )
    ...
    if ira_contributions_documented > 0.0 and "ira_contribution_deduction" not in answers:
        missing_items.append(
            f"Form 5498 documents {ira_contributions_documented:,.2f} of IRA contributions. Confirm how much is deductible for 2025 before applying any IRA deduction."
        )
    ...
    facts = {
        ...
        "ira_contributions_documented": build_fact(
            "ira_contributions_documented",
            ira_contributions_documented,
            ira_contributions_documented_sources,
        ),
