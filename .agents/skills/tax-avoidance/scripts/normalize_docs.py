...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    known_itemized_deductions_total = mortgage_interest + charitable_cash
    ...
    if deduction_amount > 0.0 and known_itemized_deductions_total > deduction_amount:
        missing_items.append(
            "Review whether itemizing deductions is better than the chosen deduction amount; "
            f"known mortgage-interest and charitable documents already total ${known_itemized_deductions_total:,.2f}."
        )
    ...
    normalized: dict[str, Any] = {
        ...
        "deduction_summary": {
            ...
            "known_itemized_deductions_total": known_itemized_deductions_total,
            "itemized_review_needed": deduction_amount > 0.0
            and known_itemized_deductions_total > deduction_amount,
        },
