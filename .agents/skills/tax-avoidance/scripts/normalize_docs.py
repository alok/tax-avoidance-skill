...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    social_security_taxable_from_docs, social_security_taxable_doc_sources = aggregate_numeric(
        documents,
        {"SSA-1099"},
        "taxable_benefits",
    )
    ...
    social_security_taxable_from_answers, social_security_taxable_answer_sources = answer_fact(
        answers,
        "taxable_social_security_benefits",
    )
    if social_security_taxable_doc_sources:
        social_security_taxable_benefits = social_security_taxable_from_docs
        social_security_taxable_sources = social_security_taxable_doc_sources
    else:
        social_security_taxable_benefits = social_security_taxable_from_answers
        social_security_taxable_sources = social_security_taxable_answer_sources
    ...
    if social_security > 0.0 and not social_security_taxable_sources:
        missing_items.append(
            "Provide the taxable Social Security benefits amount for Form 1040 line 6b, or confirm that the taxable amount should be treated as zero."
        )
