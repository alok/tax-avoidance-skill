...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if ira_contributions_reported > 0.0 and "ira_contribution_deduction" not in answers:
        missing_items.append(
            f"Review Form 5498 contributions totaling ${ira_contributions_reported:,.2f} and confirm the deductible IRA amount; reported contributions are not always fully deductible."
        )
