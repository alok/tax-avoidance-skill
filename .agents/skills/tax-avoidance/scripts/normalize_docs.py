...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    taxable_social_security, taxable_social_security_sources = aggregate_numeric(
        documents,
        {"SSA-1099"},
        "taxable_benefits",
    )
    ...
    if has_ssa1099 and taxable_social_security == 0.0 and "taxable_social_security_benefits" not in answers:
        missing_items.append(
            "Confirm the taxable Social Security amount before finalizing Form 1040 line 6b; do not assume the full SSA-1099 benefit is taxable."
        )
    ...
    facts = {
        ...
        "taxable_social_security_benefits": build_fact(
            "taxable_social_security_benefits",
            taxable_social_security_answer if "taxable_social_security_benefits" in answers else taxable_social_security,
            taxable_social_security_answer_sources
            if "taxable_social_security_benefits" in answers
            else taxable_social_security_sources,
        ),
