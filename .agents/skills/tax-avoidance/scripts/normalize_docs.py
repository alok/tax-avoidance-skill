...
def normalize_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    reported_ira_contributions, reported_ira_sources = aggregate_numeric_aliases(
        documents,
        {"5498"},
    ...
    if reported_ira_contributions > 0.0 and "ira_contribution_deduction" not in answers:
        missing_items.append(
            "Review the Form 5498 IRA contribution amount and confirm how much is deductible before applying any IRA adjustment to the draft return."
        )
