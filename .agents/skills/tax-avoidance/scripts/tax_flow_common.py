...
def standard_deduction_amount(tax_year: int, filing_status: str | None) -> float | None:
    if not filing_status:
        return None
    return STANDARD_DEDUCTION_BY_YEAR_AND_STATUS.get(tax_year, {}).get(filing_status)
