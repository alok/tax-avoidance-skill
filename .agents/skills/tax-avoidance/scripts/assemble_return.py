...
def build_line_items(normalized: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "value": social_security if social_security or fact_sources(normalized, "social_security_benefits") else None,
        ...
        },
        {
            ...
            "value": (
                ...
                if taxable_social_security or fact_sources(normalized, "taxable_social_security_benefits")
                else None
            ),
