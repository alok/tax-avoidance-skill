...
def build_dossier(normalized: dict[str, Any], line_items: list[dict[str, Any]]) -> str:
    ...
    candidate_ira_rows = [
        [
            contribution.get("field") or "unknown",
    ...
    sections = [
        ...
        *connector_lines,
        ...
        "",
        f"- Found Form 5498 traditional IRA contribution candidates totaling {money(candidate_ira_contributions) if candidate_ira_contributions else '$0.00'} that are not yet applied to Form 1040 line 10.",
        "",
        make_markdown_table(
            ["Observed Field", "Amount", "Source"],
