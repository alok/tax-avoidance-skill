...
def build_dossier(normalized: dict[str, Any], line_items: list[dict[str, Any]]) -> str:
    ...
    retirement_review_lines = [
        (
            ...
            else "- No Form 5498 contribution amount has been extracted yet."
        ),
        (
            ...
            else "- No IRA deduction is applied yet. Review the 5498 amount and deductibility limits before adding one."
        ),
    ]
