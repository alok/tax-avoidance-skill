...
def build_dossier(normalized: dict[str, Any], line_items: list[dict[str, Any]]) -> str:
    ...
    gross_social_security = fact_value(normalized, "social_security_benefits")
    taxable_social_security = fact_value(normalized, "taxable_social_security_benefits")
    ...
    social_security_review_lines = [
        f"- Gross Social Security benefits spotted from SSA-1099 documents: {money(gross_social_security) if gross_social_security else '$0.00'}",
        (
            ...
            else "- No taxable Social Security amount is applied yet. Review the SSA-1099 benefits before filling Form 1040 line 6b."
        ),
    ]
