...
def build_dossier(normalized: dict[str, Any], line_items: list[dict[str, Any]]) -> str:
    ...
    social_security_review_lines = [
        f"- SSA-1099 benefits found: {money(social_security) if social_security else '$0.00'}",
        (
            ...
            else "- Taxable Social Security is not auto-computed here. Review the benefits worksheet and confirm line 6b explicitly."
        ),
    ]
