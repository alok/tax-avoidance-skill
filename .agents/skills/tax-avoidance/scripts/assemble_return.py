...
def build_dossier(normalized: dict[str, Any], line_items: list[dict[str, Any]]) -> str:
    ...
    retirement_review_lines = [
        (
            f"- Reported IRA contributions spotted from Form 5498 documents: {money(ira_contributions_reported)}"
            if ira_contributions_reported
            else "- No IRA contributions were extracted from Form 5498 documents."
        ),
        (
