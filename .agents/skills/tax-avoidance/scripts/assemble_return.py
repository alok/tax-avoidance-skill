...
def fact_provided(normalized: dict[str, Any], key: str) -> bool:
    return bool(normalized["facts"].get(key, {}).get("provided", False))
...
def build_line_items(normalized: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    has_business_expenses = fact_provided(normalized, "business_expenses")
    net_profit = None
    ...
    taxable_income = (
        ...
        if fact_provided(normalized, "deduction_amount")
        else None
    )
    ...
    total_tax = (
        ...
        if fact_provided(normalized, "tax_before_credits")
        else None
    )
    ...
    return [
        ...
        },
        {
            ...
            "value": deduction_amount if fact_provided(normalized, "deduction_amount") else None,
        ...
        },
        {
            ...
            "line": "16",
            "label": "Tax",
            "value": tax_before_credits if fact_provided(normalized, "tax_before_credits") else None,
