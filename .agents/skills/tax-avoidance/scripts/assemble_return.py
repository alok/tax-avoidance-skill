...
def build_line_items(normalized: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    taxable_social_security = (
        fact_value(normalized, "taxable_social_security_benefits") if has_taxable_social_security else 0.0
    )
...
def build_dossier(normalized: dict[str, Any], line_items: list[dict[str, Any]]) -> str:
    ...
    social_security_benefits = fact_value(normalized, "social_security_benefits")
    taxable_social_security_sources = fact_sources(normalized, "taxable_social_security_benefits")
    has_taxable_social_security = bool(taxable_social_security_sources)
    ...
    social_security_review_lines = [
        f"- SSA-1099 benefits spotted: {money(social_security_benefits) if social_security_benefits else '$0.00'}",
        (
            ...
            else "- No taxable Social Security amount is applied yet. Review the SSA-1099 with the rest of the household income before setting Form 1040 line 6b."
        ),
    ]
