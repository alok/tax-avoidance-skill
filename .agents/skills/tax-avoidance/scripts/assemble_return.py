...
def build_line_items(normalized: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    social_security_benefits = fact_value(normalized, "social_security_benefits")
    taxable_social_security = fact_value(normalized, "taxable_social_security")
    ...
    return [
        ...
        },
        {
            ...
            "value": social_security_benefits or None,
        ...
        },
        {
            ...
            "sources": fact_sources(normalized, "taxable_social_security"),
            "rule_citations": rule_citations("taxable_social_security"),
        },
        {
            "form": "Form 1040",
            "line": "7",
...
def build_dossier(normalized: dict[str, Any], line_items: list[dict[str, Any]]) -> str:
    ...
    social_security_review_lines = [
        f"- Gross SSA-1099 benefits spotted: {money(social_security_benefits) if social_security_benefits else '$0.00'}",
        (
            f"- Taxable Social Security amount currently applied on Form 1040 line 6b: {money(taxable_social_security)}"
            if taxable_social_security
            else "- No taxable Social Security amount is applied yet. Review the SSA-1099 worksheet before adding any amount to Form 1040 line 6b."
        ),
    ]
