...
- The dossier should separately surface **candidate IRA contribution amounts** from Form 5498 so the user can confirm what, if any, amount is actually deductible.
