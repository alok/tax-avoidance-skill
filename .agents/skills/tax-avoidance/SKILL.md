...
- Treat `SSA-1099` as review-first support: preserve total benefits, but only apply a taxable amount to Form 1040 line `6b` after that amount is separately confirmed.
