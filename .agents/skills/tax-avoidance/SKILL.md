...
- Safe dependent intake scaffolding using non-sensitive household fields such as relationship, birth year, months at home, student status, and support-test notes
...
5. Preserve household and dependent context without collecting SSNs or claiming final eligibility decisions.
6. Ask only the missing interview questions needed to assemble the supported return.
