...
- If an `SSA-1099` is present, ask for the taxable-benefits result before finalizing Form 1040 line `6b`; do not treat the full benefits amount as automatically taxable.
