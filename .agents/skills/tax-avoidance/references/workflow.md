...
- If an `SSA-1099` is present, preserve the gross benefits on the form and ask for the taxable Social Security amount instead of assuming the full benefit is taxable.
