...
5. Capture household/dependent review facts with labels only if the user may claim anyone.
...
- For dependents, collect only the minimum review facts needed to assess credit paths: relationship, age, residency, support, and whether another taxpayer may claim them. Never store SSNs in the repo artifacts.
