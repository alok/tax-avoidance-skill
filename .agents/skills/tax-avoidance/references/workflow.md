...
5. Capture sanitized household and dependent facts when they matter for credits or filing status review; do not collect SSNs into the artifact set.
...
- If dependents are present, ask only the specific missing relationship, age, residency, support, and joint-return questions needed for credit review.
