...
- If a `5498` is present, surface the observed IRA contribution amount as a deduction-review input instead of silently treating the full amount as deductible.
