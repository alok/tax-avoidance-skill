...
- If `SSA-1099` appears, do not guess the taxable amount. Preserve gross benefits and ask for the taxable portion before using Form 1040 line 6b in the draft package.
