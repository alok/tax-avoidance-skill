...
- If Social Security benefits are present, preserve the total benefit amount for Form 1040 line 6a but ask for the taxable-benefit result before using line 6b in totals.
