...
- Do not silently convert Form 5498 contribution amounts into an IRA deduction. Surface them as candidate IRA inputs and ask the user to confirm the deductible amount.
