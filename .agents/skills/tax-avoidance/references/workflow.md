...
- If education, IRA, or HSA forms appear, convert them into specific next questions instead of assuming the raw form amount is already the final credit or deduction input.
