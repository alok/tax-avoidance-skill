...
- Social Security is handled as a review-first workflow: preserve the `SSA-1099` total benefits, then apply only a user-confirmed taxable amount to Form 1040 line `6b`
