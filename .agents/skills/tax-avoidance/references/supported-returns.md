...
- Automatic 2025 standard-deduction defaults for `single` and `married_filing_jointly`, with explicit deduction override support for itemized or hand-checked flows
