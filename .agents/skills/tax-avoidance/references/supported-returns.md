...
- Social Security benefits are preserved conservatively: line `6a` can be populated from `SSA-1099`, while line `6b` stays review-only until the taxable portion is known
