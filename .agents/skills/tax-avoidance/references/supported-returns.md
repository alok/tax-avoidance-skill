...
- Income: W-2 wages, 1099-NEC contractor income, taxable interest, ordinary dividends, capital gains summaries, and Social Security review workflows
...
- Social Security handling: carry gross `SSA-1099` benefits into the artifacts, but require an explicit taxable-benefit confirmation before finalizing Form 1040 line 6b and downstream totals
