...
- `SSA-1099` Social Security support is review-first: total benefits are captured, but the taxable portion must be confirmed before Form 1040 line `6b` is finalized
