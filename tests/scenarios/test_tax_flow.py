...
class TaxFlowTest(unittest.TestCase):
    ...
    def test_ira_5498_intake_review(self) -> None:
        normalized, artifacts = self.run_case("ira_5498_intake_review")
        self.assertEqual(normalized["status"], "ok")
        ...
        self.assertIn("$0.00", artifacts["tax-dossier.md"])
        self.assertIn("traditional IRA contributions totaling $6,500.00", artifacts["missing-items.md"])
        self.assertIn("Roth IRA contributions", artifacts["missing-items.md"])
