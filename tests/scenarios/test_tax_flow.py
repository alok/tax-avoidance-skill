...
class TaxFlowTest(unittest.TestCase):
    ...
    def test_ira_review_5498(self) -> None:
        ...
        self.assertIn(
            "Review the traditional IRA contributions reported on Form 5498",
            artifacts["missing-items.md"],
        )
        self.assertIn(
            "No IRA deduction is applied yet. Review the Form 5498 contribution details before adding one.",
