...
class TaxFlowTest(unittest.TestCase):
    ...
    def test_social_security_requires_taxable_amount(self) -> None:
        normalized, artifacts = self.run_case("social_security_requires_taxable_amount")
        self.assertEqual(normalized["status"], "ok")
        self.assertIn(
            "Determine the taxable portion of SSA-1099 benefits",
    ...
    def test_social_security_taxable_amount(self) -> None:
        ...
        self.assertIn("| Form 1040 | 6b | Taxable social security benefits | $9,000.00 |", artifacts["federal-lines.md"])
        self.assertIn("| Form 1040 | 9 | Total income | $9,000.00 |", artifacts["federal-lines.md"])
