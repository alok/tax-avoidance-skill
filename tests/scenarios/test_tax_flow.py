...
class TaxFlowTest(unittest.TestCase):
    ...
    def test_dependent_intake_scaffolding(self) -> None:
        ...
        self.assertIn("child tax credit amount", artifacts["missing-items.md"])
        self.assertIn("birth year for Noah", artifacts["missing-items.md"])
        self.assertIn("valid SSN or ITIN", artifacts["missing-items.md"])
