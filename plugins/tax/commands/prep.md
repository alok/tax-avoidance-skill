...
4. Preserve safe household and dependent context without collecting SSNs or pretending to decide eligibility.
5. Ask only the missing questions required for a supported return.
