...
- Adds targeted substantiation follow-up for common deductions and credits, so the artifact set asks for records like `1098-E`, `1098-T`, IRA contribution proof, clean-credit support, and estimated-tax confirmations before those amounts are treated as final.
...
8. Ask for supporting documents when a claimed deduction or credit still lacks substantiation.
