...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces deduction-support documents clearly, including mortgage-interest, charitable-receipt, and student-loan-interest support, so the user can choose the deduction path with less manual review.
