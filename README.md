...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Defaults supported 2025 standard deductions automatically for `single` and `married_filing_jointly` returns, while separately surfacing known itemized-deduction signals from gathered documents.
