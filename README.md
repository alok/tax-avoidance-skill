...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Treats `SSA-1099` intake as a review workflow: it captures total benefits, asks for the taxable portion instead of guessing it, and only applies the confirmed amount to Form 1040 line `6b`.
