...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a supporting-facts appendix to the public-facing markdown artifacts so adjustments, deductions, Social Security inputs, and other extracted values stay visible even when they do not map cleanly to a single draft federal line.
