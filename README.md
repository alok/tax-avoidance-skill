...
- Carries gross `SSA-1099` benefits into the artifact set, but leaves the taxable portion in review mode until the user confirms the Form 1040 line 6b amount.
