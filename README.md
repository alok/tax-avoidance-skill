...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Includes a structured **Next Questions** queue in the normalized JSON and markdown artifacts so the agent can continue a TurboTax-style interview with minimal backtracking.
