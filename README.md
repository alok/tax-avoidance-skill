...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces mortgage-interest and charitable-receipt evidence in an explicit itemized-deduction review section so the user can compare itemizing against the standard deduction before finalizing the draft package.
