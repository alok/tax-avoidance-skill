...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Makes the next interview step explicit with a structured question queue in `return-data.json`, `tax-dossier.md`, and `missing-items.md`, including blocking vs. review follow-ups.
