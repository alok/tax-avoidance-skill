...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Turns `1098` mortgage-interest forms and donation receipts into explicit deduction-review scaffolding so the user can compare candidate itemized deductions against the standard deduction before choosing the draft amount.
...
5. Turn mortgage-interest and donation documents into a deduction-review checklist before asking the user to lock the draft deduction amount.
