...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Preserves common W-2 Box 12 payroll items such as retirement deferrals, employer HSA contributions, and reported health-coverage cost so they stay visible in the draft package.
