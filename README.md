...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Derives a **targeted interview checklist** from the discovered forms so the next questions read more like TurboTax and less like a generic tax questionnaire.
...
8. Turn missing facts into targeted follow-up questions based on the actual forms already found.
