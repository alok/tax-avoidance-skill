...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Carries forward federal estimated tax payments when the user provides quarterly payment confirmations or already knows the amounts.
...
If the user made quarterly payments, an even better version is:
