...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review scaffold in the dossier so mortgage-interest and charitable-giving documents are surfaced as itemized-deduction candidates before the user locks in a deduction amount.
