...
- Surfaces mortgage-interest and cash-donation documents as **itemized deduction candidates** so the user can choose standard vs. itemized with the relevant evidence in view.
...
7. Surface likely business-expense receipts separately from confirmed deductible expenses, and keep itemized-deduction candidates visible when the deduction path is still undecided.
