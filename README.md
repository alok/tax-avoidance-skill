...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review section to the dossier so mortgage interest, charitable receipts, student loan interest, and the chosen deduction path are visible before line 12 is finalized.
