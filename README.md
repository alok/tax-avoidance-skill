...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Treats Form `5498` as intake evidence for IRA contributions and surfaces it for follow-up without silently converting the full amount into a deduction claim.
