...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Turns supporting deduction documents such as `1098`, `1098-E`, `5498`, and donation receipts into explicit interview follow-up prompts instead of silently claiming those values.
...
6. Turn document-derived deduction signals into explicit follow-up questions instead of auto-applying them.
