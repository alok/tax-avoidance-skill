...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces Form `5498` traditional IRA contribution evidence in the artifacts and asks for deductible-amount confirmation instead of silently applying an unsafe assumption.
