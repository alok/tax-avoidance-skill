...
This repository targets **simple federal individual returns** only: single or married-filing-jointly households with wage, contractor, and investment income plus common deductions and credits. It supports a simple Schedule C skeleton for contractor `1099-NEC` work when gross receipts are known and business expenses can be gathered. It recognizes `1098-T` tuition statements as education-credit review evidence and now treats `5498`, `5498-SA`, and `1098-E` as deduction-review evidence so the dossier can carry those amounts forward without silently applying them. It still excludes rental income, K-1s, stock options, QSBS, trusts, estates, multistate returns, and international filings.
...
7. Surface deduction-review evidence from `5498`, `5498-SA`, and `1098-E` before applying any corresponding adjustment to the draft return.
