...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces a deduction-review section inside `tax-dossier.md` so mortgage interest, student loan interest, charitable receipts, and Form 5498 IRA contributions stay visible even when they still need user confirmation.
