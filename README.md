...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Keeps deduction and adjustment scaffolding visible even before a final deduction path is chosen, including student-loan-interest inputs and itemized-deduction candidates such as mortgage interest and charitable receipts.
