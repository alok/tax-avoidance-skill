...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Preserves deduction-review context in the artifacts so mortgage-interest and charitable-giving evidence stays visible even before the standard-vs-itemized choice is finalized.
