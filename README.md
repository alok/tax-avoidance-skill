...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds deduction scaffolding that compares documented mortgage-interest and charitable-giving evidence against the official 2025 standard deduction before finalizing Form 1040 line 12.
...
6. Assemble a prefilled federal line map, a deduction comparison, and a human-readable dossier.
