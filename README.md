...
- Prompts for missing resident-state and work-state context even on otherwise federal-only draft runs, so later state work starts from preserved facts instead of a blank slate.
