...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Turns supported deduction documents such as `5498`, `1098-E`, mortgage-interest statements, and donation receipts into explicit review prompts when the draft still needs a deductible amount decision.
