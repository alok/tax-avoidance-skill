...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Treats `5498` IRA contribution statements as review evidence. It surfaces the reported contribution amount in the artifact set, but it does not silently turn that amount into a deductible IRA adjustment.
