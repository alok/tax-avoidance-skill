...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces a deduction-support snapshot so the user can review mortgage interest, charitable receipts, and student loan interest before locking in a deduction choice.
