...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces `1098-T` tuition and scholarship amounts as education-credit scaffolding instead of inventing an American opportunity or lifetime learning credit without the missing eligibility facts.
