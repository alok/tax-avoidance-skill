...
- Surfaces mortgage-interest and charitable-giving records in an explicit **itemized deduction review** section so the user can decide standard vs itemized without guessing from raw documents.
