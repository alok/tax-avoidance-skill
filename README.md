...
- Keeps `SSA-1099` support review-safe by surfacing Form 1040 lines `6a/6b` explicitly and asking for the taxable-benefits figure when it has not been confirmed yet.
