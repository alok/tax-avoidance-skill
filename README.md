...
- Recognizes `1098-T` tuition statements and carries tuition plus scholarship totals into an explicit education-credit review section without pretending to auto-compute the final credit.
