...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces supported adjustment and benefit documents such as `SSA-1099`, `1098-E`, mortgage-interest statements, and donation receipts in reviewable artifact sections instead of leaving them buried in raw inventory.
