...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Prefills IRA contribution deductions from supported `5498` documents when the contribution amount is present, instead of forcing a duplicate manual answer.
