...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction and adjustment scaffold to the dossier so mortgage interest, charitable receipts, student loan interest, IRA, and HSA inputs stay visible even before every tax rule is fully automated.
