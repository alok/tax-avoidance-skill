...
- Carries `SSA-1099` Social Security benefits into Form 1040 lines `6a/6b` and explicitly asks for the taxable amount when the document or interview does not provide it.
