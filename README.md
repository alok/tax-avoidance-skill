...
- Surfaces document-derived deduction review hints for supported forms such as `5498`, `1098-E`, `1098`, and donation receipts instead of silently claiming those deductions.
...
8. Clearly label legal planning moves, missing items, document-derived review hints, unsupported complexity, state follow-up, and anything that needs professional review.
