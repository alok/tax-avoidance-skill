...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Auto-compares the 2025 standard deduction against the itemized deductions already captured from documents and answers, then explains the draft deduction choice in the dossier.
