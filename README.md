...
- Carries `SSA-1099` benefits into the artifact set and explicitly asks for the taxable-benefits worksheet result when Form 1040 line 6b cannot be inferred safely.
