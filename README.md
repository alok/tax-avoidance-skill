...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Treats Form `5498` IRA contributions as review evidence: it preserves the reported contribution amount and asks for a deductibility confirmation before applying any IRA deduction.
