...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Scaffolds a 2025 standard-vs-known-itemized deduction comparison so the draft can keep moving even before the user has answered the full deduction interview.
