...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Carries federal withholding from supported 1099 and SSA-style documents into the draft payment lines instead of making the user re-enter those amounts manually.
