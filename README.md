...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review section that surfaces student loan interest, mortgage-interest support, and charitable receipts without silently forcing an itemized deduction.
...
8. Clearly label legal planning moves, deduction-review evidence, missing items, unsupported complexity, state follow-up, and anything that needs professional review.
