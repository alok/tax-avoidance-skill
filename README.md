...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Surfaces a dedicated **Deduction Signals** section so the user can see already-gathered mortgage-interest, charitable-giving, student-loan-interest, IRA, and HSA inputs before choosing the final deduction amount.
