...
- Treats `SSA-1099` intake as a review step: it surfaces total benefits on Form 1040 line `6a`, but requires a confirmed taxable-benefits amount before line `6b` is finalized.
