...
- Treats `1098-E` student loan interest as an intake signal by default and asks for an explicit deductible amount instead of silently applying the reported figure.
