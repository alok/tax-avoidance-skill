...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Tracks documented quarterly estimated tax payments separately from generic payment credits so Form 1040 payments stay auditable.
...
6. Preserve estimated tax payment evidence from 1040-ES style receipts or confirmations when present.
