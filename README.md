...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Organizes follow-up into a structured intake checklist so the output clearly separates missing documents, interview questions, review confirmations, and state follow-up.
