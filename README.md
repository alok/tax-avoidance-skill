...
- Surfaces deduction-support documents such as `1098`, `1098-E`, and donation receipts in a review section before relying on them in the draft return.
...
Observed `1098-E` student loan interest is recorded as review evidence, but the workflow now waits for an explicit deductible amount before applying it to Schedule 1 adjustments.
