...
- Builds an **itemized-deduction intake scaffold** from supported source documents like mortgage-interest statements and donation receipts, while still requiring an explicit deduction choice before filing.
