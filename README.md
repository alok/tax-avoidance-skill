...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Shows a `Planning Inputs` section in the dossier so mortgage-interest, charitable, student-loan-interest, and basic credit inputs stay visible even before the final deduction path is confirmed.
