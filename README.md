...
- Treats `SSA-1099` benefits as a review workflow: gross benefits are surfaced on Form 1040 line `6a`, while line `6b` stays `TBD` until the taxable amount is explicitly confirmed.
