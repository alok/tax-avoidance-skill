...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Shows a deduction-review section in the dossier so mortgage interest, charitable receipts, and above-the-line adjustments stay visible even when they are not auto-applied.
