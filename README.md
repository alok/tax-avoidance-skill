...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deterministic intake-progress summary to `return-data.json` and `tax-dossier.md` so the user can see which interview stages are complete, pending, or not needed.
