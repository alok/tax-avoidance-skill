...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review scaffold that keeps mortgage interest, cash donations, student-loan interest, and Form 5498 IRA contributions visible even before the final deduction decision is made.
