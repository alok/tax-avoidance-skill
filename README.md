...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Renders a prioritized TurboTax-style next-question queue inside the existing artifacts so the agent can ask the minimum high-impact follow-ups in order.
