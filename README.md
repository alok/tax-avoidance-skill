...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Derives a prioritized next-question plan from the documents already found, so the user gets targeted TurboTax-style follow-up instead of a generic questionnaire.
