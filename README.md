...
- Carries gross `SSA-1099` benefits into the artifact set and explicitly asks for the taxable-benefits determination instead of silently treating the full amount as taxable income.
