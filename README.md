...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review scaffold to the dossier so mortgage interest, student loan interest, and charitable receipts are visible before the user locks in the Form 1040 line 12 amount.
