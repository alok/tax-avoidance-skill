...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Preserves Form 5498 IRA contribution totals as an interview signal, while still requiring an explicit deductibility review before any amount is applied to the draft return.
