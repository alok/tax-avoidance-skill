...
- Treats Form `5498` IRA contributions as review-only intake evidence until deduction eligibility is confirmed, instead of silently applying an IRA deduction.
