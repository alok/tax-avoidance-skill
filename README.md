...
- Treats `SSA-1099` gross benefits as review-only unless a taxable amount is explicitly supplied, so the draft package does not silently overstate taxable income.
