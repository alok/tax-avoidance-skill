...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review section that keeps visible mortgage-interest and cash-donation support separate from the chosen draft deduction, so standard-vs-itemized follow-up stays explicit.
...
8. Keep deduction-path review explicit by showing visible itemized support separately from the chosen draft deduction amount.
