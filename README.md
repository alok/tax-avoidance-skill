...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review worksheet to the dossier so mortgage-interest and donation documents trigger an explicit standard-vs-itemized decision instead of being silently ignored.
