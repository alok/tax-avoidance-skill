...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-intake view to the dossier so mortgage-interest, donation, and student-loan-interest support is visible before the final deduction choice is locked.
...
7. Show deduction support already found, including visible itemized-deduction subtotal inputs, before asking the user to choose a final deduction amount.
