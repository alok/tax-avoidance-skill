...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a deduction-review scaffold so mortgage-interest and charitable-receipt evidence shows up as itemized-deduction signals instead of disappearing into raw normalized facts.
