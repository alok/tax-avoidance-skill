...
- Preserves public-safe dependent intake scaffolding so household context, child-credit review needs, and care-expense follow-up survive the interview without storing SSNs or full birth dates in the generated artifacts.

## Scope

This repository targets **simple federal individual returns** only: single or married-filing-jointly households with wage, contractor, and investment income plus common deductions and credits. It supports a simple Schedule C skeleton for contractor `1099-NEC` work when gross receipts are known and business expenses can be gathered, plus household/dependent scaffolding for child-credit and care-credit follow-up without persisting sensitive identifiers. It still excludes rental income, K-1s, stock options, QSBS, trusts, estates, multistate returns, and international filings.
