...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Preserves safe household and dependent context for later child-credit review without retaining SSNs in normalized artifacts.
...
The example input also demonstrates safe dependent intake. Household members can be captured with lightweight fields such as relationship, age, months in the home, and childcare expenses, while sensitive identifiers stay out of the normalized output:
