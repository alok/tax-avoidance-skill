...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds Schedule SE-style contractor scaffolding when 1099-NEC income and business expenses are known, including net earnings, self-employment tax, and the deductible half-SE adjustment.
...
8. Show contractor self-employment tax scaffolding separately from final filing figures so the user can review it before filing.
