...
- Preserves SSA-1099 benefits and only fills taxable Social Security on Form 1040 line 6b when that taxable amount is explicitly provided or reviewed, instead of guessing from the gross benefit amount.
