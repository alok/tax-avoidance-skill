...
- Auto-recommends a base standard-versus-observed-itemized deduction path for supported filing statuses, while labeling any confirmation caveats instead of silently finalizing the choice.
