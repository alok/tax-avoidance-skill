...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds deduction-path scaffolding when the user has not chosen between standard and itemized deductions yet, including a 2025 standard-deduction reference and the itemized subtotal that can actually be seen in the provided docs.
