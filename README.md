...
- Adds simple Schedule SE scaffolding for contractor flows: net earnings, self-employment tax, and deductible half-SE tax with explicit review notes.

## Scope

This repository targets **simple federal individual returns** only: single or married-filing-jointly households with wage, contractor, and investment income plus common deductions and credits. It supports a simple Schedule C skeleton for contractor `1099-NEC` work when gross receipts are known and business expenses can be gathered, plus basic Schedule SE scaffolding for self-employment tax. It still excludes rental income, K-1s, stock options, QSBS, trusts, estates, multistate returns, international filings, optional SE methods, and advanced payroll edge cases.
