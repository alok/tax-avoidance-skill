...
- Adds a reviewable Schedule SE-style self-employment tax scaffold for supported contractor flows, including deductible half-SE tax, while flagging W-2 wage-box and Additional Medicare review items.
...
8. Show a reviewable self-employment tax scaffold for supported Schedule C cases instead of leaving contractor total-tax impacts hidden.
