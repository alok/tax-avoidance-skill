...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Treats quarterly estimated tax payments as first-class inputs so contractor-style flows can carry them into the draft 1040 instead of burying them in generic notes.
...
This repository targets **simple federal individual returns** only: single or married-filing-jointly households with wage, contractor, and investment income plus common deductions, credits, and estimated-tax-payment tracking. It supports a simple Schedule C skeleton for contractor `1099-NEC` work when gross receipts are known and business expenses can be gathered. It still excludes rental income, K-1s, stock options, QSBS, trusts, estates, multistate returns, and international filings.
...
5. Capture deductible adjustments, credits, and quarterly estimated tax payments in explicit fields instead of leaving them as freeform notes.
