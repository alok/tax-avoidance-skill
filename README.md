...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds an explicit adjustment-and-deduction review so mortgage interest, student loan interest, IRA/HSA inputs, and charitable receipts show up as a clear deduction-path scaffold before anything is silently treated as itemized.
