...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Adds a dedicated **Deduction Review** section to the dossier so Form 1098, 1098-E, 5498, and donation evidence stay visible even when a final deduction choice still needs review.
