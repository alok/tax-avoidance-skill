...
- Produces the same artifact set every time:
  ...
  - `federal-lines.md`
  - `missing-items.md`
- Preserves deduction evidence from `1098`, `1098-E`, `5498`, and donation receipts in a dedicated review section so the user can confirm eligibility-sensitive amounts before they are drafted onto the return.
